		...
		$Saran_penyakit = $_POST['Saran_penyakit'];
            ...
            $file_tmp = $_FILES['file']['tmp_name'];	
                if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
                    ...
                    $sql = "INSERT INTO data_penyakit (nama_penyakit, detail_penyakit,saran_penyakit,gambar)
                    VALUES ('$Nama_penyakit', '$Detail_penyakit', '$Saran_penyakit','$nama')";
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <input required autocomplete="off" type="text" placeholder="Masukkan penyakit baru..." class="form-control" name="Nama_penyakit" size="30">
          </td>
        </tr>
      <tr>
        <td width="120">Detail Penyakit</td>
        <td> 
          <textarea required rows="4" cols="50" class="form-control" name="Detail_penyakit" type="text" placeholder="Masukkan detail penyakit baru..."></textarea>
        </td>
      </tr>
      <tr>
        <td width="120">Saran Penyakit</td><td><textarea required rows="4" cols="50" class="form-control" name="Saran_penyakit" type="text" placeholder="Masukkan saran penyakit baru..."></textarea>
        </td>
      </tr>
          <tr>
            <td width="120">Gambar (Max 1 MB)</td>
            <td>Upload Gambar : <input required type="file" class="form-control" name="file" required="">
            </td>
          </tr>     
          <tr>
            <td>
            ...
            <input required type="submit" name="Submit" value="Add">
