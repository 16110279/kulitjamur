  ...
  <main id="main">
    ...
    <tbody>
      <tr>
        ...
        <td>
          <input class="form-control" autocomplete="off" placeholder="Ketik password lama..." type="password" name="oldPass">
        </td>
      </tr>
    <tr>
      <td>Masukkan password baru</td>
      <td>
        <input class="form-control" autocomplete="off" placeholder="Ketik password baru..." type="password" name="newPass1"></td></tr>
    <tr>
      <td>Masukkan kembali password baru</td>
      <td>
        <input class="form-control" autocomplete="off" placeholder="Ulangi password baru..." type="password" name="newPass2"></td></tr>
    <tr>
      <td>
