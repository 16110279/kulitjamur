    ...
    <table class="table table-bordered">
      <tbody>
        <tr>
          <td>Nama Lengkap</td>   
          <td>  
            <input required autocomplete="off" placeholder="Masukkan nama lengkap..." type="text" class="form-control" name="Nama_lengkap" size="30">
          </td>
        </tr>
          <tr>
            <td>Username</td>  
             <td>  <input required autocomplete="off" placeholder="Masukkan username..." type="text" class="form-control" name="Username" size="30"></td></tr>
      <tr>
        <td>Password</td>   
        <td> 
          <input required autocomplete="off" placeholder="Masukkan password admin..." type="password" class="form-control" name="Password" size="30">
        </td>
      </tr>
      <tr>
        <td>
     <td><input required type="submit" name="Submit" value="Add"></td>
      </td>
    </tr>
          </tbody>
        </table>
