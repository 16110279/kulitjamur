...
<body>
  ...
  <main id="main">
    ...
    <table class="table table-bordered">
      <tbody>
        <form name="text_form" method="POST" action="modul/gejala/aksi_gejala.php?module=gejala&amp;act=input" onsubmit="return Blank_TextField_Validator()">
          <br><br><table class="table table-bordered">
      <tbody><tr><td width="120">Nama Gejala</td><td><input type="text" autocomplete="off" placeholder="Masukkan gejala baru..." class="form-control" name="nama_gejala" size="30"></td></tr>
