...
<body>
  ...
  <main id="main">
    ...
    <table class="table table-bordered">
      <tbody>
        <form name="text_form" method="POST" action="modul/penyakit/aksi_penyakit.php?module=penyakit&amp;act=input" onsubmit="return Blank_TextField_Validator()" enctype="multipart/form-data">
          <br>
          <br>
          <table class="table table-bordered">
      <tbody>
        <tr>
          ...
          <td>
            <input autocomplete="off" type="text" placeholder="Masukkan penyakit baru..." class="form-control" name="nama_penyakit" size="30">
          </td>
        </tr>
      <tr>
        <td width="120">Detail Penyakit</td>
        <td> 
          <textarea rows="4" cols="50" class="form-control" name="det_penyakit" type="text" placeholder="Masukkan detail penyakit baru..."></textarea>
        </td>
      </tr>
      <tr>
        <td width="120">Saran Penyakit</td><td><textarea rows="4" cols="50" class="form-control" name="srn_penyakit" type="text" placeholder="Masukkan saran penyakit baru..."></textarea>
        </td>
      </tr>
          <tr>
