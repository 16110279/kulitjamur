...
<body>
  ...
  <main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
     <form name="text_form" method="POST" action="modul/pengetahuan/aksi_pengetahuan.php?module=pengetahuan&amp;act=update" onsubmit="return Blank_TextField_Validator()">
          <input type="hidden" name="id" value="2">
          <br><br><table class="table table-bordered">
      <tbody><tr><td width="120">Penyakit</td><td><select class="form-control" name="kode_penyakit" id="kode_penyakit"><option value="4"> Tetelo (Newcastle Disease)</option><option value="9">Batuk Ayam Menahun (Infectious Bronchitis)</option><option value="11">Batuk Darah (Infectious Laryngo Tracheitis)</option><option value="6">Berak Darah (Coccidosis)</option><option value="1" selected="">Berak Kapur (Pullorum Disease)</option><option value="10">Busung Ayam (Lymphoid Leukosis)</option><option value="3">Flu Burung (Avian Influenza)</option><option value="7">Gumboro (Infectious Bursal Disease)</option><option value="2">Kolera Ayam (Fowl Cholera)</option><option value="12">Mareks (Mareks Disease)</option><option value="13">Produksi Telur (Egg Drop Syndrome 76/EDS 76)</option><option value="8">Salesma Ayam (Infectious Coryza)</option><option value="5">Tipus Ayam (Fowl Typhoid)</option></select></td></tr>
    <tr><td>Gejala</td><td><select class="form-control" name="kode_gejala" id="kode_gejala"><option value="41">Badan kurus</option><option value="5">Batuk</option><option value="37">Batuk berdarah</option><option value="31">Bergerombol di sudut kandang</option><option value="36">Bernafas dengan mulut sambil menjulurkan leher</option><option value="4">Bersin-bersin</option><option value="6">Bulu kusam dan berkerut</option><option value="7">Diare</option><option value="39">Duduk dengan sikap membungkuk</option><option value="16">Jengger pucat</option><option value="17">Kaki dan sayap lumpuh</option><option value="43">Kaki pincang</option><option value="9">Kedinginan</option><option value="40">Kelihatan mengantuk dengan bulu berdiri</option><option value="18">Keluar cairan dari mata dan hidung</option><option value="35">Kelumpuhan pada tembolok</option><option value="19">Kepala bengkak</option><option value="20">Kepala terputar</option><option value="26">Kerabang telur kasar</option><option value="33">Kerabang telur pucat</option><option value="30">Kotoran atau feses berdarah</option><option value="28">Kotoran kuning kehijauan</option><option value="25">Mati secara mendadak</option><option value="32">Mematuk daerah kloaka</option><option value="11">Mencret kehijau-hijauan</option><option value="12" selected="">Mencret keputih-putihan</option><option value="13">Muka pucat</option><option value="3">Nafas ngorok basah</option><option value="2">Nafas sesak / megap-megap</option><option value="1">Nafsu makan berkurang </option><option value="14">Nampak membiru</option><option value="29">Pembengkakan daerah fasial dan sekitar mata</option><option value="21">Pembengkakan dari sinus dan mata</option><option value="15">Pembengkakan pial</option><option value="22">Perut membesar</option><option value="8">Produksi telur menurun</option><option value="27">Putih Telur Encer</option><option value="23">Sayap menggantung</option><option value="10">Tampak lesu</option><option value="34">Telur lebih kecil</option><option value="24">Terdapat kotoran putih menempel disekitar anus</option><option value="42">Terdapat lendir bercampur darah pada rongga mulut</option><option value="38">Tidur paruhnya diletakkan dilantai</option></select></td></tr>
    <tr><td>MB</td><td><input autocomplete="off" placeholder="Masukkan MB" type="text" class="form-control" name="mb" size="15" value="0.8"></td></tr>
    <tr><td>MD</td><td><input autocomplete="off" placeholder="Masukkan MD" type="text" class="form-control" name="md" size="15" value="0.0"></td></tr>
