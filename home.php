...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
      ...
      <p>Selamat datang di Website Puskesmas Karangtalun, <br> untuk konsultasi masalah kulit bisa langsung daftarkan diri sebagai pasien klik <a href="formregister.php"><p>Register!!!</p></a>
    </div>
  </section><!-- End Hero -->
