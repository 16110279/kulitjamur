...
<body>
    ...
    <div class="d-flex flex-column">
      ...
      <nav class="nav-menu">
        <ul>
          ...
          <li class="active"><a href="penyakit/index.php"><i class="bx bx-bug"></i> <span>Penyakit</span></a></li>
          ...
          <li class="active"><a href="post_ket.php"><i class="bx bx-file"></i>Post Keterangan</a></li>
  ...
  <br><br><br><br>
      ...
      <h2 align="center">Di Website Puskesmas Karangtalun</h2>

    </div><br><br>
    <p>Kulit merupakan organ tubuh yang paling besar, dan salah satu yang paling rumit. Ia memiliki banyak peran dalam memelihara kehidupan dan kesehatan, tapi juga memiliki banyak potensi masalah, dengan lebih dari 3.000 kemungkinan kelainan kulit. Kulot juga berperan penting sebagai batas pelindung yang kedap udara, kedap air, dan fleksibel, antara dunia luar dan sistem yang sangat teratur didalam tubuh. Kulit juga membantu dalam regulasi suhu, pertahanan kekebalan tubuh, produksi vitamin dan sensasi rasa.</p>
  </section><!-- End Hero -->
