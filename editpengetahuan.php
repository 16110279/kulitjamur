        ...
        <tr>
          ...
          <td>
            <select class="form-control" name="kode_penyakit" id="kode_penyakit">
              <option value="4"> Tetelo (Newcastle Disease)</option>
              <option value="9">Batuk Ayam Menahun (Infectious Bronchitis)</option>
              <option value="11">Batuk Darah (Infectious Laryngo Tracheitis)</option>
              <option value="6">Berak Darah (Coccidosis)</option>
              <option value="1" selected="">Berak Kapur (Pullorum Disease)</option><option value="10">Busung Ayam (Lymphoid Leukosis)</option><option value="3">Flu Burung (Avian Influenza)</option><option value="7">Gumboro (Infectious Bursal Disease)</option><option value="2">Kolera Ayam (Fowl Cholera)</option><option value="12">Mareks (Mareks Disease)</option><option value="13">Produksi Telur (Egg Drop Syndrome 76/EDS 76)</option><option value="8">Salesma Ayam (Infectious Coryza)</option><option value="5">Tipus Ayam (Fowl Typhoid)</option></select></td></tr>
