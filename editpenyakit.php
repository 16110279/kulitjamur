...
<body>
  ...
  <main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
     <form name="text_form" method="POST" action="modul/penyakit/aksi_penyakit.php?module=penyakit&amp;act=update" onsubmit="return Blank_TextField_Validator()" enctype="multipart/form-data">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <input autocomplete="off" type="text" class="form-control" name="nama_penyakit" size="30" value="Berak Kapur (Pullorum Disease)"></td></tr>
      <tr>
        <td width="120">Detail Penyakit</td><td><textarea rows="4" cols="50" type="text" class="form-control" name="det_penyakit">Pullorum Disease disebut juga Bacillary White Diarrhea dan yang lebih popular disebut penyakit berak kapur atau berak putih.</textarea></td></tr>
      <tr><td width="120">Saran Penyakit</td><td><textarea rows="4" cols="50" type="text" class="form-control" name="srn_penyakit">Berikan Master Coliprim dosis: 1 gr/1 ltr air selama 3-4 hari (1/2 hari) berturut-turut. setelah itu berikan Master Vit-Stress selama 3-4 hari untuk membantu proses penyembuhan.</textarea></td></tr>
          ...
          <tr><td></td><td><img id="preview" src="gambar/penyakit/01BerakKapur.jpg" width="200"></td></tr>          
